...
export const OPTIONAL_LIVE_CHANNELS: LiveChannel[] = [
  ...
  { id: 'rt', name: 'RT', handle: '', fallbackVideoId: 'iEpJwprxDdk' },
  ...
  { id: 'wion', name: 'WION', handle: '@WION', fallbackVideoId: '9Auq9mYxFEE' },
  ...
  { id: 'arirang-news', name: 'Arirang News', handle: '@ArirangCoKrArirangNEWS', fallbackVideoId: 'aUDm173E8k8' },
  ...
  { id: 'tv5monde-info', name: 'TV5 Monde Info', handle: '@TV5MONDEInfo', fallbackVideoId: 'Ap-UM1O9RBU' },
  { id: 'nrk1', name: 'NRK1', handle: '@nrk', fallbackVideoId: 'bjgQzJzCZKs' },
